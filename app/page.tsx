        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <a
                href="#how"
                className="inline-flex items-center justify-center rounded-full border border-neutral-300 px-6 py-3 font-semibold hover:bg-neutral-100"
              >
                How it works
              </a>
            </div>
          ...
          <div className="relative">
            {/* Replace these src values with your AI hero image later (e.g., /hero.jpg) */}
            ...
            <div className="absolute -bottom-6 -right-6 hidden sm:block">
              <div className="rounded-2xl bg-white shadow-xl p-4 w-64">
                ...
                <p className="text-xs text-neutral-600 mt-1">
                  Thoughtful pacing—from first hello to first visit.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-neutral-700">
            ...
            Replace these placeholders with your own AI images anytime.
          </p>

          <div className="mt-8 grid gap-4 sm:gap-6 grid-cols-2 md:grid-cols-3">
            {/* Swap these with /gallery1.jpg, /gallery2.jpg, /gallery3.jpg etc. later */}
            {[
      ...
      <footer className="border-t border-neutral-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            <a href="#apply" className="hover:text-rose-700">
              Apply
            </a>
            <a href="mailto:info@minglingheartschina.com" className="hover:text-rose-700">
              info@minglingheartschina.com
            </a>
          </div>
        </div>
